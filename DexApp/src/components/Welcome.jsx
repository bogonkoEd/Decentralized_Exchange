...
const Input =({placeholder,name,type,value,handleChange}) => (
  ...
  className='my-2 w-full rounded-sm p-2 bg-violet-400 text-white border-none '
      ...
      <div className='flex md:flex-row flex-col items-start justify-between md:p-10 py-12 px-4'>
        ...
        <div className='flex flex-col flex-1 items-center justify-center w-full md:mt-0 mt-10'>
          ...
          <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center gradient-bg-form rounded-lg' >
            <Input placeholder="Receiver's Ethereum Network Address" name="receiverAddress" type="text " handleChange={()=>{}} />
